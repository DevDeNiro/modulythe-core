...
@Service
@RefreshScope
public class TechnicalRestClient {

    private static final Logger LOGGER = LoggerFactory.getLogger(TechnicalRestClient.class);
    ...
    public TechnicalRestClient(RestTemplate restTemplate) {
